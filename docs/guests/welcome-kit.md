...
Dubai had none. In London, the kit is the first physical proof that this house is different. It should feel **considered, useful and personal**, not a bag of swag.
...
|---|---|---|---|
| **Handwritten welcome note** from the host | The single most memorable item | ✔ | |
| **The week, printed**: a small booklet with the schedule, map and contacts | They know what's happening | Name on the cover | |
| **Quality umbrella** (compact, branded underneath the canopy) | London in November; useful all week, and it shows up in content | | ✔ |
| **Heavyweight hoodie or knit** in a SagaDAO House London colourway | Worn on camera, worn after | Sized from form | ✔ |
| **Key tag** in brass or leather, engraved with the room number and "SagaDAO House London 2026" | A keepsake; doubles as a room key holder | Room no. | |
...
- **Option C:** a quality tote holding one partner item and the field guide
